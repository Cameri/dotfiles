...
local globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "Print", function ()
		util.capture_region()
              ...
              {description = "capture region", group = "hotkeys"}),
    awful.key({ altkey }, "Print", function () util.capture_window() end,
...
awful.rules.rules = {
    ...
    -- Set Telegram to always map to the media tag on screen 1
    {
